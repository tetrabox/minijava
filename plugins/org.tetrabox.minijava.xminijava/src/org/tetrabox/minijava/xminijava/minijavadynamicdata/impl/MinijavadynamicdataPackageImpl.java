...
import org.tetrabox.minijava.xminijava.miniJava.impl.MiniJavaPackageImpl;
...
public class MinijavadynamicdataPackageImpl extends EPackageImpl implements MinijavadynamicdataPackage {
	 ...
	 * @see org.tetrabox.minijava.xminijava.minijavadynamicdata.MinijavadynamicdataPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEOperation(instanceEClass, ecorePackage.getEString(), "customToString", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (instanceEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
