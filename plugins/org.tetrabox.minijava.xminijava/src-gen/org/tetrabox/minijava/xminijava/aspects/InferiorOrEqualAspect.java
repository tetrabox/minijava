...
public class InferiorOrEqualAspect extends ExpressionAspect {
  ...
  public static Value evaluateExpression(final InferiorOrEqual _self, final State state) {
	final org.tetrabox.minijava.xminijava.aspects.InferiorOrEqualAspectInferiorOrEqualAspectProperties _self_ = org.tetrabox.minijava.xminijava.aspects.InferiorOrEqualAspectInferiorOrEqualAspectContext
			.getSelf(_self);
	Object result = null;
