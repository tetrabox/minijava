...
public class InferiorAspect extends ExpressionAspect {
  ...
  public static Value evaluateExpression(final Inferior _self, final State state) {
	final org.tetrabox.minijava.xminijava.aspects.InferiorAspectInferiorAspectProperties _self_ = org.tetrabox.minijava.xminijava.aspects.InferiorAspectInferiorAspectContext
			.getSelf(_self);
	Object result = null;
