...
public class DivisionAspect extends ExpressionAspect {
  ...
  public static Value evaluateExpression(final Division _self, final State state) {
	final org.tetrabox.minijava.xminijava.aspects.DivisionAspectDivisionAspectProperties _self_ = org.tetrabox.minijava.xminijava.aspects.DivisionAspectDivisionAspectContext
			.getSelf(_self);
	Object result = null;
