...
public class EqualityAspect extends ExpressionAspect {
  ...
  public static Value evaluateExpression(final Equality _self, final State state) {
	final org.tetrabox.minijava.xminijava.aspects.EqualityAspectEqualityAspectProperties _self_ = org.tetrabox.minijava.xminijava.aspects.EqualityAspectEqualityAspectContext
			.getSelf(_self);
	Object result = null;
      ...
      if ((left instanceof StringValue)) {
        ...
        if ((left instanceof BooleanValue)) {
          ...
          if ((left instanceof RefValue)) {
            Instance _instance = ((RefValue)left).getInstance();
            Instance _instance_1 = ((RefValue) right).getInstance();
            _xifexpression_3 = (_instance == _instance_1);
          } else {
