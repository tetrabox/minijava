...
public class MiniJavaGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DomainmodelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.tetrabox.MiniJava.Domainmodel");
	...
	public class DataTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.tetrabox.MiniJava.DataType");
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.tetrabox.MiniJava.Entity");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.tetrabox.MiniJava.Feature");
		private final Group cGroup = (Group)rule.eContents().get(1);
