 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.miniJava.impl.BlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockImpl extends MethodBodyImpl implements Block
{
  ...
  public EList<BlockStatement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<BlockStatement>(BlockStatement.class, this, MiniJavaPackage.BLOCK__STATEMENTS);
    }
    return statements;
  }
