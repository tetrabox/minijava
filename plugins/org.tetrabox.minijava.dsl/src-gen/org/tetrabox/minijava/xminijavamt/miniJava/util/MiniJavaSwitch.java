...
public class MiniJavaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MiniJavaPackage.CLASS: {
				org.tetrabox.minijava.xminijavamt.miniJava.Class class_ = (org.tetrabox.minijava.xminijavamt.miniJava.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(org.tetrabox.minijava.xminijavamt.miniJava.Class object) {
		return null;
	}
