 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.xminijavamt.miniJava.impl.RefValueImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RefValueImpl extends ValueImpl implements RefValue {
	...
	protected EClass eStaticClass() {
		return MiniJavaPackage.Literals.REF_VALUE;
	}
		...
		if (instance != null && instance.eIsProxy()) {
			...
			if (instance != oldInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MiniJavaPackage.REF_VALUE__INSTANCE, oldInstance, instance));
			}
		}
		return instance;
	}
	...
	public void setInstance(Instance newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniJavaPackage.REF_VALUE__INSTANCE, oldInstance, instance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MiniJavaPackage.REF_VALUE__INSTANCE:
