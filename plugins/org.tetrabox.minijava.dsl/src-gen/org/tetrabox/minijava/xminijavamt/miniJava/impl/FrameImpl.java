 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.xminijavamt.miniJava.impl.FrameImpl#getMethodcall <em>Methodcall</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijavamt.miniJava.impl.FrameImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijavamt.miniJava.impl.FrameImpl#getChildFrame <em>Child Frame</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijavamt.miniJava.impl.FrameImpl#getParentFrame <em>Parent Frame</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijavamt.miniJava.impl.FrameImpl#getRootContext <em>Root Context</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijavamt.miniJava.impl.FrameImpl#getReturnValue <em>Return Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FrameImpl extends EObjectImpl implements Frame {
		...
		if (methodcall != null && methodcall.eIsProxy()) {
			...
			if (methodcall != oldMethodcall) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MiniJavaPackage.FRAME__METHODCALL, oldMethodcall, methodcall));
			}
		}
		return methodcall;
	}
	...
	public void setMethodcall(MethodCall newMethodcall) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniJavaPackage.FRAME__METHODCALL, oldMethodcall, methodcall));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MiniJavaPackage.FRAME__METHODCALL:
