...
public class MethodAdapter extends EObjectAdapter<Method> implements org.tetrabox.minijava.xtext.miniJava.Method {
  ...
  public void setBody(final Block o) {
    if (o != null)
    	adaptee.setBody(((org.tetrabox.minijava.xminijava.adapters.minijavamt.miniJava.BlockAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.eINSTANCE.getMethod();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.METHOD__NAME:
    		return getName();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.METHOD__TYPE_REF:
    		return getTypeRef();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.METHOD__ACCESS:
    		return getAccess();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.METHOD__ABSTRACT:
    		return isAbstract() ? Boolean.TRUE : Boolean.FALSE;
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.METHOD__STATIC:
    		return isStatic() ? Boolean.TRUE : Boolean.FALSE;
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.METHOD__PARAMS:
    		return getParams();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.METHOD__BODY:
    		return getBody();
    }
