...
public class InequalityAdapter extends EObjectAdapter<Inequality> implements org.tetrabox.minijava.xminijavamt.miniJava.Inequality {
  private XMiniJavaMTAdaptersFactory adaptersFactory;
  
  public InequalityAdapter() {
  ...
  public Value evaluateExpression(final State state) {
    return (Value) adaptersFactory.createAdapter(org.tetrabox.minijava.xminijava.aspects.InequalityAspect.evaluateExpression(adaptee, (org.tetrabox.minijava.xminijava.miniJava.State)((EObjectAdapter)state).getAdaptee()
    ), eResource);
  }
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getInequality();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.INEQUALITY__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.INEQUALITY__RIGHT:
    		return getRight();
    }
