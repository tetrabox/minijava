...
public class SuperiorOrEqualAdapter extends EObjectAdapter<SuperiorOrEqual> implements org.tetrabox.minijava.xtext.miniJava.SuperiorOrEqual {
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.eINSTANCE.getSuperiorOrEqual();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.SUPERIOR_OR_EQUAL__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.SUPERIOR_OR_EQUAL__RIGHT:
    		return getRight();
    }
