...
public class ClassAdapter extends EObjectAdapter<org.tetrabox.minijava.xminijava.miniJava.Class> implements org.tetrabox.minijava.xminijavamt.miniJava.Class {
  ...
  public org.tetrabox.minijava.xminijavamt.miniJava.Class getSuperClass() {
    return (org.tetrabox.minijava.xminijavamt.miniJava.Class) adaptersFactory.createAdapter(adaptee.getSuperClass(), eResource);
  }
  
  @Override
  public void setSuperClass(final org.tetrabox.minijava.xminijavamt.miniJava.Class o) {
    if (o != null)
    	adaptee.setSuperClass(((org.tetrabox.minijava.xminijava.adapters.xminijavamt.miniJava.ClassAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getClass_();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.CLASS__NAME:
    		return getName();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.CLASS__ACCESS_LEVEL:
    		return getAccessLevel();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.CLASS__IMPLEMENTS:
    		return getImplements();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.CLASS__MEMBERS:
    		return getMembers();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.CLASS__ABSTRACT:
    		return isAbstract() ? Boolean.TRUE : Boolean.FALSE;
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.CLASS__SUPER_CLASS:
