...
public class MinusAdapter extends EObjectAdapter<Minus> implements org.tetrabox.minijava.xtext.miniJava.Minus {
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.eINSTANCE.getMinus();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.MINUS__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.MINUS__RIGHT:
    		return getRight();
    }
