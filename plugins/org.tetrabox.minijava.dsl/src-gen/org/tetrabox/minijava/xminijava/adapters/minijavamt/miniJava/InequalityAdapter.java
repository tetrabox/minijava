...
public class InequalityAdapter extends EObjectAdapter<Inequality> implements org.tetrabox.minijava.xtext.miniJava.Inequality {
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.eINSTANCE.getInequality();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.INEQUALITY__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.INEQUALITY__RIGHT:
    		return getRight();
    }
