...
public class InterfaceAdapter extends EObjectAdapter<Interface> implements org.tetrabox.minijava.xminijavamt.miniJava.Interface {
  ...
  private EList<org.tetrabox.minijava.xminijavamt.miniJava.Interface> implements_;
  
  @Override
  public EList<org.tetrabox.minijava.xminijavamt.miniJava.Interface> getImplements() {
    if (implements_ == null)
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getInterface();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.INTERFACE__NAME:
    		return getName();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.INTERFACE__ACCESS_LEVEL:
    		return getAccessLevel();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.INTERFACE__IMPLEMENTS:
    		return getImplements();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.INTERFACE__MEMBERS:
    		return getMembers();
    }
