...
public class MultiplicationAdapter extends EObjectAdapter<Multiplication> implements org.tetrabox.minijava.xminijavamt.miniJava.Multiplication {
  ...
  public Value evaluateExpression(final State state) {
    return (Value) adaptersFactory.createAdapter(org.tetrabox.minijava.xminijava.aspects.MultiplicationAspect.evaluateExpression(adaptee, (org.tetrabox.minijava.xminijava.miniJava.State)((EObjectAdapter)state).getAdaptee()
    ), eResource);
  }
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getMultiplication();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.MULTIPLICATION__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.MULTIPLICATION__RIGHT:
    		return getRight();
    }
