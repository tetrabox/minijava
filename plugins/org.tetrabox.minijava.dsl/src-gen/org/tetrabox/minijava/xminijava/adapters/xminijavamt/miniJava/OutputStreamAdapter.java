...
public class OutputStreamAdapter extends EObjectAdapter<OutputStream> implements org.tetrabox.minijava.xminijavamt.miniJava.OutputStream {
  ...
  public EList<String> getStream() {
    return adaptee.getStream();
  }
  
  @Override
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getOutputStream();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.OUTPUT_STREAM__STREAM:
    		return getStream();
    }
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.OUTPUT_STREAM__STREAM:
    		return getStream() != null && !getStream().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.OUTPUT_STREAM__STREAM:
    		getStream().clear();
    		getStream().addAll((Collection) newValue);
    		return;
    }
