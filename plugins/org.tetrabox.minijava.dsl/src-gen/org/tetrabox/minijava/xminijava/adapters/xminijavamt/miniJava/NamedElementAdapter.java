...
public class NamedElementAdapter extends EObjectAdapter<NamedElement> implements org.tetrabox.minijava.xminijavamt.miniJava.NamedElement {
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getNamedElement();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.NAMED_ELEMENT__NAME:
    		return getName();
    }
