...
public class FieldAdapter extends EObjectAdapter<Field> implements org.tetrabox.minijava.xtext.miniJava.Field {
  ...
  public void setDefaultValue(final Expression o) {
    if (o != null)
    	adaptee.setDefaultValue(((org.tetrabox.minijava.xminijava.adapters.minijavamt.miniJava.ExpressionAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.eINSTANCE.getField();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.FIELD__NAME:
    		return getName();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.FIELD__TYPE_REF:
    		return getTypeRef();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.FIELD__ACCESS:
    		return getAccess();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.FIELD__DEFAULT_VALUE:
