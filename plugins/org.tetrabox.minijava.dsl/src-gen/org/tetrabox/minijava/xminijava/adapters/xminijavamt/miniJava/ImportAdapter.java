...
public class ImportAdapter extends EObjectAdapter<Import> implements org.tetrabox.minijava.xminijavamt.miniJava.Import {
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getImport();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.IMPORT__IMPORTED_NAMESPACE:
