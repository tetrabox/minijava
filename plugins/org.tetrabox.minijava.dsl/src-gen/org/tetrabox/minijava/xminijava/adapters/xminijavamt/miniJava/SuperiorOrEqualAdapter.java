...
public class SuperiorOrEqualAdapter extends EObjectAdapter<SuperiorOrEqual> implements org.tetrabox.minijava.xminijavamt.miniJava.SuperiorOrEqual {
  private XMiniJavaMTAdaptersFactory adaptersFactory;
  
  public SuperiorOrEqualAdapter() {
  ...
  public Value evaluateExpression(final State state) {
    return (Value) adaptersFactory.createAdapter(org.tetrabox.minijava.xminijava.aspects.SuperiorOrEqualAspect.evaluateExpression(adaptee, (org.tetrabox.minijava.xminijava.miniJava.State)((EObjectAdapter)state).getAdaptee()
    ), eResource);
  }
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getSuperiorOrEqual();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.SUPERIOR_OR_EQUAL__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.SUPERIOR_OR_EQUAL__RIGHT:
    		return getRight();
    }
