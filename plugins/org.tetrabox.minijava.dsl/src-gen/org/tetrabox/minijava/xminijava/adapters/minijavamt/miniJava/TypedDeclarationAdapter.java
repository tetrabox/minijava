...
public class TypedDeclarationAdapter extends EObjectAdapter<TypedDeclaration> implements org.tetrabox.minijava.xtext.miniJava.TypedDeclaration {
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.eINSTANCE.getTypedDeclaration();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.TYPED_DECLARATION__NAME:
    		return getName();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.TYPED_DECLARATION__TYPE_REF:
    		return getTypeRef();
    }
