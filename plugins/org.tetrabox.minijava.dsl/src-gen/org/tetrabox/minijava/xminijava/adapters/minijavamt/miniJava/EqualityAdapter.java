...
public class EqualityAdapter extends EObjectAdapter<Equality> implements org.tetrabox.minijava.xtext.miniJava.Equality {
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.eINSTANCE.getEquality();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.EQUALITY__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.EQUALITY__RIGHT:
    		return getRight();
    }
