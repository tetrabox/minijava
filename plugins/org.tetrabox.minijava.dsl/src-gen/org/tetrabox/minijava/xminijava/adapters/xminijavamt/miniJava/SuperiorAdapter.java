...
public class SuperiorAdapter extends EObjectAdapter<Superior> implements org.tetrabox.minijava.xminijavamt.miniJava.Superior {
  ...
  public Value evaluateExpression(final State state) {
    return (Value) adaptersFactory.createAdapter(org.tetrabox.minijava.xminijava.aspects.SuperiorAspect.evaluateExpression(adaptee, (org.tetrabox.minijava.xminijava.miniJava.State)((EObjectAdapter)state).getAdaptee()
    ), eResource);
  }
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getSuperior();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.SUPERIOR__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.SUPERIOR__RIGHT:
    		return getRight();
    }
