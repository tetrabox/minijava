...
public class PlusAdapter extends EObjectAdapter<Plus> implements org.tetrabox.minijava.xminijavamt.miniJava.Plus {
  ...
  public Value evaluateExpression(final State state) {
    return (Value) adaptersFactory.createAdapter(org.tetrabox.minijava.xminijava.aspects.PlusAspect.evaluateExpression(adaptee, (org.tetrabox.minijava.xminijava.miniJava.State)((EObjectAdapter)state).getAdaptee()
    ), eResource);
  }
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.eINSTANCE.getPlus();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.PLUS__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xminijavamt.miniJava.MiniJavaPackage.PLUS__RIGHT:
    		return getRight();
    }
