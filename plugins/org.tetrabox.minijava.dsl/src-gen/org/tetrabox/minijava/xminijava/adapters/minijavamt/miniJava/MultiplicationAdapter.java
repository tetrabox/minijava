...
public class MultiplicationAdapter extends EObjectAdapter<Multiplication> implements org.tetrabox.minijava.xtext.miniJava.Multiplication {
  ...
  public EClass eClass() {
    return org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.eINSTANCE.getMultiplication();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.MULTIPLICATION__LEFT:
    		return getLeft();
    	case org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage.MULTIPLICATION__RIGHT:
    		return getRight();
    }
