...
public class StandaloneSetup {
  ...
  public void doEMFRegistration() {
    ...
    EPackage.Registry.INSTANCE.put(
    	org.tetrabox.minijava.xminijava.minijavadynamicdata.MinijavadynamicdataPackage.eNS_URI,
    	org.tetrabox.minijava.xminijava.minijavadynamicdata.MinijavadynamicdataPackage.eINSTANCE
    );
    EPackage.Registry.INSTANCE.put(
  ...
  public void doAdaptersRegistration() {
    ...
    MelangeRegistry.LanguageDescriptor xMiniJava = new MelangeRegistryImpl.LanguageDescriptorImpl(
    	"org.tetrabox.minijava.XMiniJava", "", "http://org.tetrabox.minijava.xminijava/minijavadynamicdata/", "org.tetrabox.minijava.XMiniJavaMT"
    );
    MelangeRegistry.INSTANCE.getLanguageMap().put(
