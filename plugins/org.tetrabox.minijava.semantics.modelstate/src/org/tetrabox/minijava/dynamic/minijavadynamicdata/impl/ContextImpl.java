 ...
 *   <li>{@link org.tetrabox.minijava.dynamic.minijavadynamicdata.impl.ContextImpl#getChildContext <em>Child Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextImpl extends MinimalEObjectImpl.Container implements Context {
	...
	public void setParentContext(Context newParentContext) {
		if (newParentContext != eInternalContainer() || (eContainerFeatureID() != MinijavadynamicdataPackage.CONTEXT__PARENT_CONTEXT && newParentContext != null)) {
			...
			if (newParentContext != null)
				msgs = ((InternalEObject)newParentContext).eInverseAdd(this, MinijavadynamicdataPackage.CONTEXT__CHILD_CONTEXT, Context.class, msgs);
	...
	public NotificationChain basicSetChildContext(Context newChildContext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MinijavadynamicdataPackage.CONTEXT__CHILD_CONTEXT, oldChildContext, newChildContext);
	...
	public void setChildContext(Context newChildContext) {
		if (newChildContext != childContext) {
			...
			if (childContext != null)
				msgs = ((InternalEObject)childContext).eInverseRemove(this, MinijavadynamicdataPackage.CONTEXT__PARENT_CONTEXT, Context.class, msgs);
			if (newChildContext != null)
				msgs = ((InternalEObject)newChildContext).eInverseAdd(this, MinijavadynamicdataPackage.CONTEXT__PARENT_CONTEXT, Context.class, msgs);
			msgs = basicSetChildContext(newChildContext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinijavadynamicdataPackage.CONTEXT__CHILD_CONTEXT, newChildContext, newChildContext));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MinijavadynamicdataPackage.CONTEXT__CHILD_CONTEXT:
				if (childContext != null)
					msgs = ((InternalEObject)childContext).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MinijavadynamicdataPackage.CONTEXT__CHILD_CONTEXT, null, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case MinijavadynamicdataPackage.CONTEXT__PARENT_CONTEXT:
				return eInternalContainer().eInverseRemove(this, MinijavadynamicdataPackage.CONTEXT__CHILD_CONTEXT, Context.class, msgs);
		}
