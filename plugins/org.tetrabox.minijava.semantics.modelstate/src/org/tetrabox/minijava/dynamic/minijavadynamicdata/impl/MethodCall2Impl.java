 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.dynamic.minijavadynamicdata.impl.MethodCall2Impl#getMethodcall <em>Methodcall</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodCall2Impl extends CallImpl implements MethodCall2 {
	...
	protected EClass eStaticClass() {
		return MinijavadynamicdataPackage.Literals.METHOD_CALL2;
	}
		...
		if (methodcall != null && methodcall.eIsProxy()) {
			...
			if (methodcall != oldMethodcall) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MinijavadynamicdataPackage.METHOD_CALL2__METHODCALL, oldMethodcall, methodcall));
			}
		}
		return methodcall;
	}
	...
	public void setMethodcall(MethodCall newMethodcall) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinijavadynamicdataPackage.METHOD_CALL2__METHODCALL, oldMethodcall, methodcall));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MinijavadynamicdataPackage.METHOD_CALL2__METHODCALL:
