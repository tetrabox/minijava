 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.xtext.miniJava.MethodCall#getName <em>Name</em>}</li>
...
public interface MethodCall extends Message
{
   ...
   * @see #setName(Method)
   * @see org.tetrabox.minijava.xtext.miniJava.MiniJavaPackage#getMethodCall_Name()
   * @model
   * @generated
   */
  Method getName();
  ...
  /**
   * Sets the value of the '{@link org.tetrabox.minijava.xtext.miniJava.MethodCall#getName <em>Name</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
