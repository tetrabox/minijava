 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.model.miniJava.semantics.impl.ObjectRefValueImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectRefValueImpl extends ValueImpl implements ObjectRefValue {
	...
	protected EClass eStaticClass() {
		return SemanticsPackage.Literals.OBJECT_REF_VALUE;
	}
		...
		if (instance != null && instance.eIsProxy()) {
			...
			if (instance != oldInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SemanticsPackage.OBJECT_REF_VALUE__INSTANCE, oldInstance, instance));
			}
		}
		return instance;
	}
	...
	public void setInstance(ObjectInstance newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SemanticsPackage.OBJECT_REF_VALUE__INSTANCE, oldInstance, instance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SemanticsPackage.OBJECT_REF_VALUE__INSTANCE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SemanticsPackage.OBJECT_REF_VALUE___COPY:
				return copy();
			case SemanticsPackage.OBJECT_REF_VALUE___CUSTOM_TO_STRING:
