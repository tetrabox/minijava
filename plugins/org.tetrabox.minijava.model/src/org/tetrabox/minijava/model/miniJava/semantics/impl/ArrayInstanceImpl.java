 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.model.miniJava.semantics.impl.ArrayInstanceImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.tetrabox.minijava.model.miniJava.semantics.impl.ArrayInstanceImpl#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayInstanceImpl extends MinimalEObjectImpl.Container implements ArrayInstance {
	...
	protected EClass eStaticClass() {
		return SemanticsPackage.Literals.ARRAY_INSTANCE;
	}
	...
	public EList<Value> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<Value>(Value.class, this, SemanticsPackage.ARRAY_INSTANCE__VALUE);
		}
		return value;
	}
	...
	public void setSize(int newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SemanticsPackage.ARRAY_INSTANCE__SIZE, oldSize, size));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SemanticsPackage.ARRAY_INSTANCE__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SemanticsPackage.ARRAY_INSTANCE__VALUE:
				return getValue();
			case SemanticsPackage.ARRAY_INSTANCE__SIZE:
				return getSize();
		}
